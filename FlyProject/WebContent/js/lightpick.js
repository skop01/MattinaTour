...
(function (root, factory) {
    ...
    renderYearsList = function(date, opts)
    {
        var d = moment(date),
            ...
            maxYear = years && years.max ? years.max : Number.parseInt(moment().format('YYYY년'));

        if (Number.parseInt(date.format('YYYY년')) < minYear) {
            minYear = Number.parseInt(date.format('YYYY년'));
        }

        if (Number.parseInt(date.format('YYYY년')) > maxYear) {
            maxYear = Number.parseInt(date.format('YYYY년'));
        }
    ...
    renderCalendar = function(el, opts)
    {
        ...
        for (var i = 0; i < opts.numberOfMonths; i++) {
            ...
            + renderYearsList(day, opts)+'<b>'+"년 "+'</b>'
    ...
    Lightpick = function(options)
    {
        ...
        self._onChange = function(e)
        {
            ...
            if (!target) {
             ...
             if (target.classList.contains('lightpick__select-years')) {
             ...
             else if (target.classList.contains('lightpick__select-months')) {
